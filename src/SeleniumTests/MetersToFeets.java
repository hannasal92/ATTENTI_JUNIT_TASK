...
//        firstTest("13","m ");
//        GeneralMethods.backToMainPage(driver);
//        firstTest("111","meters ");
//        GeneralMethods.backToMainPage(driver);
//        firstTest("55"," meters");
//        GeneralMethods.backToMainPage(driver);
//        firstTest("124"," meters ");
//        GeneralMethods.backToMainPage(driver);
//        System.out.println("--------------");
...
//        fourthTest("   "," m");
    ...
    public String firstTest( String checkValue , String symbol ) throws InterruptedException {
        ...
        Thread.sleep(2000);
        String check_result = GeneralMethods.checkTheExpectedResultAndActualResultMetersToFeet(checkValue,symbol,driver);
        Thread.sleep(2000);
        return check_result ;
    }
