...
public class GeneralMethods {
    ...
    public static String checkResults(String expectedResult, String actualResult) throws Exception {
        try{
    ...
    public static String checkTheExpectedResultAndActualResult(String checkValue, String symbol, WebDriver driver) throws InterruptedException {
        String check  = null ;
        ...
        try {
            ...
            check =  GeneralMethods.checkResults(allExpectedValue, actualValue);
            Thread.sleep(2000);
            return check ;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static String checkTheExpectedResultAndActualResultMetersToFeet(String checkValue, String symbol, WebDriver driver) throws InterruptedException {
        String check = null ;
        String expectedValue;
        String actualValue;
        checkValue = checkValue.trim();
    ...
    public static String checkTheExpectedResultAndActualResultOuncesToGrams(String checkValue, String symbol, WebDriver driver) throws InterruptedException {
        String check = null ;
        String expectedValue;
        String actualValue;
        checkValue = checkValue.trim();
    ...
    public static String checkTheExpectedResultAndActualResulCelciusToFahrenheitWithTablBtn
        ...
        try {
            ...
            check = GeneralMethods.checkResults(expectedValue, actualValue);
            return check ;
        } catch (Exception e) {
        e.printStackTrace();
    }
    ...
    public static String checkResultsAPITemp(WebDriver driver , String tempAPI){
        ...
        if(actualResult_int >= min_value && actualResult_int <= max_value){
            System.out.println("The Value "+actualResult+" in Range ");
            return "1" ;
